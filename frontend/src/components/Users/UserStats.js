...
const UserStats = ({ stats, roles }) => {
  ...
  const getRoleColor = (role) => {
    switch (role?.toLowerCase()) {
      ...
      case 'developer': return 'text-primary-600 dark:text-primary-400';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="card p-6 border-l-4 border-l-primary-500 hover:shadow-lg dark:hover:shadow-glow transition-all duration-300">
        ...
        <div className="card p-6 border-l-4 border-l-green-500 hover:shadow-lg dark:hover:shadow-glow transition-all duration-300">
          <div className="flex items-center">
            <div className="flex-shrink-0">
        ...
        <div className="card p-6 border-l-4 border-l-accent-500 hover:shadow-lg dark:hover:shadow-glow transition-all duration-300">
          <div className="flex items-center">
            <div className="flex-shrink-0">
        ...
        <div className="card p-6 border-l-4 border-l-yellow-500 hover:shadow-lg dark:hover:shadow-glow transition-all duration-300">
          <div className="flex items-center">
            <div className="flex-shrink-0">
      ...
      {stats.roleDistribution && Object.keys(stats.roleDistribution).length > 0 && (
        <div className="card p-6 hover:shadow-lg dark:hover:shadow-glow transition-all duration-300">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Role Distribution</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {Object.entries(stats.roleDistribution).map(([role, count]) => (
              <div key={role} className="p-4 bg-gray-50 dark:bg-white/5 rounded-lg">
        ...
        <div className="card p-6 hover:shadow-lg dark:hover:shadow-glow transition-all duration-300">
          ...
          <div className="space-y-4">
            {Object.entries(stats.activityTrends).map(([period, data]) => (
              <div key={period} className="p-4 bg-gray-50 dark:bg-white/5 rounded-lg">
        ...
        <div className="card p-6 hover:shadow-lg dark:hover:shadow-glow transition-all duration-300">
          ...
          <div className="space-y-3">
            {stats.topActiveUsers.slice(0, 10).map((user, index) => (
              <div key={user.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-white/5 rounded-lg">
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-gray-300 dark:bg-white/10 rounded-full flex items-center justify-center">
